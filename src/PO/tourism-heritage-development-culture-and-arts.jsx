...
const saveSubmissionDeadline = async () => {
  ...
  try {
    const deadlineRef = ref(
      db,
      `tourism/${auth.currentUser.uid}/${selectedYear}/metadata/deadline`
    );
...
const handleDeleteRecord = async (firebaseKey) => {
  ...
  try {
    const recordRef = ref(
              db,
              `tourism/${auth.currentUser.uid}/${selectedYear}/tourism-heritage-development-culture-and-arts/assessment/${firebaseKey}`
            );
...
useEffect(() => {
  ...
  const dataRef = ref(
    db,
    `tourism/${auth.currentUser.uid}/${selectedYear}/tourism-heritage-development-culture-and-arts/assessment`
  );
