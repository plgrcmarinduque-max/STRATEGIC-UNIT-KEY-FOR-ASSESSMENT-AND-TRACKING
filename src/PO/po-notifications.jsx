...
<span style={{ fontSize: "13px", color: "#666" }}>
  ...
  onClick={() => {
    ...
    if (item.action === "view_assessment" || item.type === "assessment_forwarded" || item.type === "assessment_submitted" || item.type === "assessment_resubmitted") {
      navigate("/po-view", {
        state: {
          year: item.year,
    ...
    } else if (item.type === "assessment_verified") {
      navigate("/po-view", {
        state: {
          year: item.year,
          municipality: item.municipality,
